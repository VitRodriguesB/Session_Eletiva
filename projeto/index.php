...
<body class="container">
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            try{
                ...
                if(($email == "adm@adm.com") && ($senha == "123") ){
                    ...
                    header('location: principal.php'); // Muda o local onde vai ser levado.
                }
                else{
                    $mensagem['erro'] = "Usuario e/ou senha incorreto";
                }
            }catch(Exception $e){
    ...
    <form action="" method="POST">
        ...
        <div class="row">
            <div class="col">
                <button type="submit" class="btn-prymary mt-3">Acessar</button>
            </div>
        </div>
    </form>
